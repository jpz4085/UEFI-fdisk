/*
TRANS The system returned an undefined/unknown error. This makes more
TRANS sense than the original description of "Success" for error zero.*/
_S(0, N_("Undefined error"))
#ifdef EPERM
/*
